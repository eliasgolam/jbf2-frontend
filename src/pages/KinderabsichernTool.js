  ...
  return (
    ...
    >
      ...
      <main className="flex-grow max-w-6xl mx-auto px-4 py-8 text-center flex flex-col items-center">
        <h2 className="text-3xl font-bold mb-2">Frühzeitig vorsorgen & planen</h2>
        <p className="text-[#7E6B64] mb-8">
          Rechne aus, wie du Kinder finanziell sinnvoll absichern kannst
        </p>
        ...
        <div
          ...
          onClick={() => navigate('/tools/kinder/kinderabsichern')}
        >
          <Lottie
            loop
...
export default KinderabsichernTool;
